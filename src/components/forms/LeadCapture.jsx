...
var EmailField = require('./EmialField.jsx');
var NameField = require('./NameField.jsx')
var Reflux = require('reflux');
var Actions = require('../../reflux/actions1.jsx');
...
var LeadCapture = React.createClass({
    ...
    onSubmit: function(e) {
      if (!this.refs.fieldEmail.state.valid) {
          alert("You suck at filling out forms. Email is always requierd in a lead capture form.")
      } else {
